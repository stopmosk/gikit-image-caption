...
def convert_predi_to_tsv_oscar2(predictions, output_folder, e, output_tsv_name='predictions.tsv'):
    ...
    tsv_writer(gen_rows_1(), op.join(output_folder, split_name + '.label.tsv'))
    tsv_writer(gen_rows_2(), op.join(output_folder, split_name + '.feature.tsv'))
