...
class VinVLDetector:
    def __init__(self, yaml_file='./sgg_bench/models/vinvl/vg/for_live.yaml'):
        ...
        relpath = op.dirname(os.path.abspath(__file__))
        cfg.MODEL.WEIGHT = op.join(relpath, '../..', cfg.MODEL.WEIGHT)
        cfg.DATASETS.LABELMAP_FILE = op.join(relpath, '../..', cfg.DATASETS.LABELMAP_FILE)
